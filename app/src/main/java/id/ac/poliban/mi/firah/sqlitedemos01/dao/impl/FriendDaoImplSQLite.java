package id.ac.poliban.mi.firah.sqlitedemos01.dao.impl;
...
import id.ac.poliban.mi.firah.sqlitedemos01.dao.FriendDao;
...
public class FriendDaoImplSQLite extends SQLiteOpenHelper implements FriendDao {
    private  static final String DB_NAME = "firah.db";
    private  static final int DB_VERSION = 2;

    public FriendDaoImplSQLite(@Nullable Context context) {
